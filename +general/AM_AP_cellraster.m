function AP_cellraster(exp_info, align_times,align_groups,unit_sort)
...
try
templates = exp_info.templates;
channel_positions = exp_info.channel_positions;
template_depths = exp_info.template_depths;
spike_times = exp_info.spike_times_timeline;
spike_templates = exp_info.spike_templates;
template_amplitudes = exp_info.template_amplitudes;
catch me
