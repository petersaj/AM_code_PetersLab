...
pakaged_norm_smooth_stim_psths = cell(num_clusters, length(psth_unique_days_from_learning));
...
[avg_psth_grouped_split_trial_smooth_norm,psth_unique_avg_animal_group_indices] = ...
    ...
    for_psth_animal_ids, ...
    [for_psth_split_trial_ids, for_psth_days_from_learning, for_psth_cluster_ids]);
...
[avg_psth_grouped_sort_RT_split_trial_smooth_norm,psth_unique_avg_animal_group_indices] = ...
    ap.nestgroupfun({@mean, @mean},cat_smooth_norm_stim_psths, ...
    for_psth_animal_ids, ...
    [for_psth_sort_RT_split_trial_ids, for_psth_days_from_learning, for_psth_cluster_ids]);
...
[avg_psth_grouped_bin_RT_split_trial_smooth_norm,psth_unique_avg_animal_group_indices] = ...
    ap.nestgroupfun({@mean, @mean},cat_smooth_norm_stim_psths, ...
    for_psth_animal_ids, ...
    [for_psth_bin_RT_split_trial_ids, for_psth_days_from_learning, for_psth_cluster_ids]);
