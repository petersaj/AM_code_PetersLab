...
if strcmp(ephys_qc_type,'bombcell')
    ...
    if  exist(qMetrics_path,'dir')
        ...
        %%%%%%%%%%% add %%%%%%
%         new_narrow_axons = qMetric.mainTrough_width < 4 & ...
%             qMetric.mainPeak_before_width < 4 ;
% 
%         narrow_not_bc = new_narrow_axons & good_templates;
% 
%         good_templates = narrow_not_bc;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5

%         %%%%% ANDRADA EDIT %%%%%%%%%%%%%%
%         good_templates = ismember(template_qc_labels,{'singleunit','multiunit', 'axon', 'noise'});

    % check new axons
%          good_templates = ismember(template_qc_labels,{'narrow_axon'}); 
%         %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
